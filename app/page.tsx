  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-9xl mx-auto">
      ...
      <section className="space-y-4 music">
        <h1 className="text-2xl font-bold mb-2">Nouveautés de la version 3.0!</h1>
        <ul>
          <li className="text-white-600 mb-6">Ajout de thèmes suivis!
            <p>Les thèmes suivis consistent a écrire sur une semaine consécutive une nouvelle complète</p>
          </li>
          <li>Amuse-toi bien!</li>
        </ul>
        <div className="flex flex-col gap-6">
          ...
          <iframe width="560" height="300" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1051128922&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
        </div>
      </section>
    </div>
  )
